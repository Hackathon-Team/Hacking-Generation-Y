...
/**
 * Renders a fading "Hello world!" in a {@link }.
 */
public class LiveCardRenderer implements DirectRenderingCallback {
    ...
    public LiveCardRenderer(Context context, DataBase data, OrientationManager orientationManager) {
        this.data=data;
    ...
    /**
     * Starts or stops rendering according to the {@link }'s state.
     */
